...
<div id="box">
<div id="wdzh_left">
      <div id="left_list"><s:a action="cart_list" namespace="/product">Shopping Cart</s:a></div>
	  <div id="left_list"><s:a action="order_findByCustomer" namespace="/product">My Order</s:a></div>
    </div>
    <div id="wdzh_right">
      <div id="right_tiao">　&gt;　Cart</div>
      <div id="biaodan">
        <table width="688" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="30" bgcolor="#e7f3c3"><table width="688" height="30" border="0" cellpadding="0" cellspacing="0" class="green">
              <tr>
                ...
                <td width="111" align="center">Remove</td>
              </tr>
            </table></td>
          </tr>
            ...
            <td><div id="xiaotiao">
              <table width="688" height="30" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  ￥<s:property value="productMarketprice"/>Dollar</span>
                  </td>
                  <td width="130" align="center">￥<s:property value="productPrice"/>Dollar<br>
			为您节省：￥<s:property value="productMarketprice*amount - productPrice*amount"/>Dollar</td>
                  ...
                  <s:a action="cart_delete" namespace="/product">
					...
					<img src="${context_path}/css/images/" width="52" height="23" />
				</s:a>
                  </td>
                </tr>
          ...
          <tr>
			...
			<img src="${context_path}/css/images/" width="105" height="32" />
            </s:a>　　
			<s:a action="index" namespace="/">
            <img src="${context_path}/css/images/" width="150" height="32" />　
            </s:a>　　
