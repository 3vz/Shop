...
<s:form action="order_list" namespace="/admin/product">
	...
	<div id="right_top"><img
		...
		class="word01">Order Check</span></div>
	<div id="right_mid">
	<div id="tiao">
	<table width="685" height="24" border="0">
		<tr>
			<td width="105" height="22" bgcolor="#c6e8ff" align="right">Order No：</td>
			<td><s:textfield name="orderId"></s:textfield></td>
		</tr>
		<tr>
			<td width="105" height="22" bgcolor="#c6e8ff" align="right">Order Status：</td>
			<td><s:radio name="orderState"
				list="@com.lyq.model.OrderState@getValues()"
				value="@com.lyq.model.OrderState@getValues()[0]"></s:radio></td>
		</tr>
		<tr>
			<td width="105" height="22" bgcolor="#c6e8ff" align="right">Username：</td>
			<td><s:textfield name="customer.username"></s:textfield></td>
		</tr>
		<tr>
			<td width="105" height="22" bgcolor="#c6e8ff" align="right">Processor：</td>
