...
<table width="693" height="29" border="0" class="word01">
	<tr>
		...
		<td width="150" align="center">Subclass</td>
		<td width="100" align="center">Add Subclass</td>
		<td width="100" align="center">Super Class</td>
		...
		<td width="150" align="center">
			...
			<s:else>
				<s:a action="category_list" namespace="/admin/product">
					<s:param name="pid" value="id"></s:param>
					has<s:property value="children.size"/>Subclass
				</s:a>
			</s:else>
		</td>
		<td width="100" align="center">
			<s:a action="category_add" namespace="/admin/product">
				<s:param name="pid" value="id"/>Add
			</s:a>
		</td>
		<td width="100" align="center">
