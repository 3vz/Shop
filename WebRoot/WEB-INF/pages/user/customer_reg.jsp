...
<div id="mid">
	...
	<table width="80%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td width="70" height="35" align="right">Username：</td>
			<td>
				<s:textfield name="username" cssClass="bian"></s:textfield>*
			</td>
		</tr>
		<tr>
			<td width="70" height="35" align="right">Password：</td>
			<td>
				<s:password name="password" cssClass="bian"></s:password>*
			</td>
		</tr>
		<tr>
			<td width="70" height="35" align="right">Confirm Password：</td>
			<td>
				<s:password name="repassword" cssClass="bian"></s:password>*
			</td>
		</tr>
		<tr>
			<td width="70" height="35" align="right">Email：</td>
			<td>
				<s:textfield name="email" cssClass="bian"></s:textfield>*
			</td>
		</tr>
		<tr>
			<td width="70" height="35" align="right">Address：</td>
			<td>
				<s:textfield name="address" cssClass="bian"></s:textfield>
			</td>
		</tr>
		<tr>
			<td width="70" height="35" align="right">Phone：</td>
			<td>
		...
		<tr>
			...
			<s:submit value="Login" type="image" src="%{context_path}/css/images/"></s:submit>
			</td>
		</tr>
	</table>
	</s:form>
