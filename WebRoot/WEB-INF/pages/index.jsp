...
<div id="left_s01"><s:a action="customer_login" namespace="/customer"><img
	src="${context_path}/css/images/" class="imgx5" /></s:a>
	<s:a action="customer_reg" namespace="/customer"><img
	src="${context_path}/css/images/" class="imgx5" /></s:a><img
	src="${context_path}/css/images/" /></div>
<div id="left_s02"><img
	src="${context_path}/css/images/" width="489" height="245"
	class="imgz5" /></div>
<!-- Type -->
...
<table width="195" border="0" cellpadding="0"
	...
	<tr>
		<td width="195" height="31"><img
			src="${context_path}/css/images/" width="195" height="29" /></td>
	</tr>
	<tr>
		<td height="5"></td>
	</tr>
